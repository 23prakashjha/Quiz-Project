...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-slate-50 via-white to-indigo-50 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-950 px-4 sm:px-6 lg:px-8 py-8 sm:py-10 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-8 animate-fade-in">
          ...
          <button
            ...
            className="mt-3 sm:mt-0 px-4 py-2.5 rounded-xl bg-linear-to-r from-fuchsia-600 to-violet-600 text-white text-sm font-bold hover:from-fuchsia-700 hover:to-violet-700 transition-all shadow-lg shadow-fuchsia-500/25"
          >
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5 mb-8">
          {[
            ...
            <div key={i} className={`bg-white dark:bg-slate-800 rounded-2xl p-5 border border-gray-200 dark:border-slate-700 shadow-sm animate-fade-in`} style={{ animationDelay: `${i * 60}ms` }}>
                  ...
                  {topicStats.map((t, i) => (
                    <div key={t.topic} className="animate-fade-in" style={{ animationDelay: `${i * 50}ms` }}>
                      ...
                      <div className="w-full h-2.5 bg-gray-200 dark:bg-slate-700 rounded-full overflow-hidden">
                        <div
                          className={`h-full rounded-full bg-linear-to-r ${scoreColor(t.avgScore)} transition-all duration-700 ease-out`}
